...
pnpm exec cdk bootstrap aws://883353268059/us-east-1 --require-approval never

env ENVIRONMENT=stage DEPLOY_CERTS_ONLY=true \
  pnpm exec cdk deploy "ProfoundBookClub-Certificate-stage" --require-approval never
...
echo "     --stack-name ProfoundBookClub-Certificate-stage --region us-east-1 \\"
...
echo "   ./scripts/deploy-infrastructure-stage.sh"
echo ""
